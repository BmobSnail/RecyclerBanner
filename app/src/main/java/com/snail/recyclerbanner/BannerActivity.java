...
import com.snail.recyclerbanner.adapter.banner.BannerAdapter;
...
public class BannerActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onResume() {
        sendBroadcast(2,BannerActivity.class.getSimpleName());
        super.onResume();
    }

    @Override
    public void onPause() {
        sendBroadcast(0,BannerActivity.class.getSimpleName());
        super.onPause();
    }

    @Override
    public void onDestroy() {
        sendBroadcast(1,BannerActivity.class.getSimpleName());
        super.onDestroy();
    }
}
